	...
	<div class="row">
		...
		<div class="col-md-8">
			...
			<form name="rs" class="form-horizontal" action="/member/regist" method="post">
				...
				<div id="pwsame" ></div>
				<label>회원이름</label><input type="text" class="form-control" name="m_name" size="30" placeholder="이름을 입력하세요." required>
				<label>회원이메일</label>　<input type="button" class="btn btn-primary" id="mailcheck" value="인증" ><input type="text" class="form-control" name="m_email" id="m_email" size="30" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" placeholder="이메일을 입력 후 인증버튼을 눌러주세요." required>
				...
				<label>회원주소</label>　<input type="button" class="btn btn-primary" id="postcodify_search_button" value="주소 검색"><br />
				...
				<input type="text" name="m_d_address" class="postcodify_details form-control" value="" placeholder="상세 주소를 입력하세요."  required><br />
